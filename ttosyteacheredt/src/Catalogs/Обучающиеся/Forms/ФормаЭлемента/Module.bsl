...
Процедура ПроверитьИЗаписатьИнформациюОбОбразовании();
	...
	ИначеЕсли ПредыдущаяИнформацияОбОбразовании.ГодОбучения		<> ГодОбучения		
		ИЛИ ПредыдущаяИнформацияОбОбразовании.УчебноеЗаведение	<> УчебноеЗаведение	
		ИЛИ ПредыдущаяИнформацияОбОбразовании.УчебноеПособие	<> УчебноеПособие 	Тогда
...
Процедура УстановитьЦены(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("УстановитьЦеныЗавершение", ЭтаФорма);
	
	ОткрытьФорму("РегистрСведений.РасценкиЗанятий.Форма.ФормаУстановкиЦен", 
				 ПараметрыФормы, 
...
&НаКлиенте
Процедура УстановитьЦеныЗавершение(ВыбранноеЗначение, ДополнительныеПараметры) Экспорт
